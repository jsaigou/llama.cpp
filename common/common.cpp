...
struct llama_context_params common_context_params_to_llama(const common_params & params) {
    ...
    // Kintsugi: enable recurrent-state rollback for all models.
    // Hybrid/recurrent archs need this for partial seq_rm to work at high context.
    // Non-recurrent archs are clamped to 0 by llama-context.cpp:55-58 downstream.
